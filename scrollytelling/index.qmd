...
2. Give it event handlers: functions that will run when something enters or exits. To start, let's keep it simple and have it apply or remove a CSS class, `.is-active`.
